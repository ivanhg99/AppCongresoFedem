...
import com.example.proyectocei.actividades.ActividadesActivity
import com.example.proyectocei.api.Constants
import com.example.proyectocei.comidas.ComidasActivity
import com.example.proyectocei.databinding.ActivityPrincipalAjenoBinding
...
class PrincipalAjenoActivity : AppCompatActivity() {


    private lateinit var toggle: ActionBarDrawerToggle

    private lateinit var binding: ActivityPrincipalAjenoBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_principal_socio)

        binding = ActivityPrincipalAjenoBinding.inflate(layoutInflater)
    ...
    private fun actividades() {
        val boton = findViewById<MaterialCheckBox>(R.id.actividades)
